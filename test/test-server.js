...
describe("Recipes", function() {
  ...
  //   2. inspect response object and prove has right status code and have
  //   right keys in response object.
  ...
  it("should add a recipe on POST", function() {
    const newRecipe = { name: "lemonade", ingredients: ["lemons", "water", "sugar"] };
    return chai
      .request(app)
      .post("/recipes")
      .send(newRecipe)
  ...
  it("should update items on PUT", function() {
    ...
    const updateData = {
      name: "lemonade",
      ingredients: ["1 lemon", "1 cup water", "1 spoon sugar"]
    };
